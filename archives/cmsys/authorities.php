...
$id          = $_GET['id'] ?? null;
$type        = $_GET['type'] ?? null;
$created_for = $_GET['created_for'] ?? null;
##########################################################################
...
while ($results = mysqli_fetch_array($termsearch)):
...
if ($results['source'] == "soc2010") { $source_title = "Standard Occupation Classification 2010"; } 
...
<option value="soc2010">Standard Occupational Classification 2010</option>
...
<?php $parts = explode(",", $results['part_order']);	
$count = 0;
foreach ($parts as $part) { 
$count = $count +1;
if ($part <> '') {
...
$term1 = mysqli_real_escape_string($id_link, $_GET['term1']);
$term2 = mysqli_real_escape_string($id_link, $_GET['term2']);
$term3 = mysqli_real_escape_string($id_link, $_GET['term3']);
$term4 = mysqli_real_escape_string($id_link, $_GET['term4']);
$term5 = mysqli_real_escape_string($id_link, $_GET['term5']);
$term6 = mysqli_real_escape_string($id_link, $_GET['term6']);
$term7 = mysqli_real_escape_string($id_link, $_GET['term7']);
$termtype1 = mysqli_real_escape_string($id_link, $_GET['termtype1']);
$termtype2 = mysqli_real_escape_string($id_link, $_GET['termtype2']);
$termtype3 = mysqli_real_escape_string($id_link, $_GET['termtype3']);
$termtype4 = mysqli_real_escape_string($id_link, $_GET['termtype4']);
$termtype5 = mysqli_real_escape_string($id_link, $_GET['termtype5']);
$termtype6 = mysqli_real_escape_string($id_link, $_GET['termtype6']);
$termtype7 = mysqli_real_escape_string($id_link, $_GET['termtype7']);
$alt_form = mysqli_real_escape_string($id_link, $_GET['alt_form']);
$alt_form_lang = $_GET['alt_form_lang'];
$use_for = mysqli_real_escape_string($id_link, $_GET['use_for']);
$locator = mysqli_real_escape_string($id_link, $_GET['locator']);
$source = $_GET['source'];
$other = $_GET['other'];
$ext_id = $_GET['ext_id'];
$notes = mysqli_real_escape_string($id_link, $_GET['notes']);
...
$subjsearch = mysqli_query($id_link, $sql_str) or ("Search Failed!");
$results = mysqli_fetch_array($subjsearch);
