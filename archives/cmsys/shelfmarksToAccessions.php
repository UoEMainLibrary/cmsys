...
echo "<tr><td>".$count."</td><td>".$results['sm_prefix'].".".$results['sm_1'].".".$results['sm_2']." ".$results['sm_suffix']."</td><td><a href='".$_SERVER['PHP_SELF']."?func=accessions2&amp;view=list&amp;year=".$results['year']."&amp;number=".$results['number']."&amp;suffix=".$results['suffix']."'>E.".$results['year'].".".$results['number']." ".$results['suffix']."</a></td><td>";
