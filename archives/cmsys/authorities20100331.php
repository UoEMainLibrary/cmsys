...
<tr><td class="label">Parish</td><td><input name="territory" size="75" type="text" value="<?php echo $results['territory'] ?>" /></td></tr>
...
$term = mysqli_real_escape_string($id_link, $_GET['term']);
$island = mysqli_real_escape_string($id_link, $_GET['island']);
$city = mysqli_real_escape_string($id_link, $_GET['city']);
$territory = mysqli_real_escape_string($id_link, $_GET['territory']);
