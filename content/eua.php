...
include "includes/upperheader.php";
   ...
   include "includes/lowerheader.php";
	 echo "<h1><a href='".$_SERVER['PHP_SELF']."'>EUA</a></h1>";
...
<table align="right" border="1" cellspacing="0" cellpadding="2" width="650" style="font-size:8pt;">
  ...
  <tr>
	...
	<!-- <li>Simple text search (boxed items only):<br />
     ...
     <li>Look for known EUA-A box number:<br />
...
<option value ="30-39">30-39 (All Senatus)</option>
...
echo "<table border='1' cellpadding='5'><thead><tr><th>Box</th><th>Contents</th><th>Old shelfmark</th></tr></thead>";


$boxsearch = mysqli_query($id_link, $sql_str) or die("Search Failed!");
while ($results = mysqli_fetch_array($boxsearch)):
echo "<tr><td><a href='".$PHP_SELF."?view=loc&amp;box=".$results['box']."'>".$results['prefix'].$results['box']."</a></td><td>".$results['contents']."</td><td>".$results['shelfmark']."</td></tr>";
endwhile;
echo "</table>";
}
	 ...
	 elseif ($view == "results_da") {
	    ...
	    if ($searchterm == "1-9") { $sql_str="SELECT * FROM eua_box_contents WHERE shelfmark LIKE '%Da.1' OR shelfmark LIKE '%Da.1.%' OR shelfmark LIKE '%Da.2' OR shelfmark LIKE '%Da.2.%' OR shelfmark LIKE '%Da.3' OR shelfmark LIKE '%Da.3.%' OR shelfmark LIKE '%Da.4' OR shelfmark LIKE '%Da.4.%' OR shelfmark LIKE '%Da.5' OR shelfmark LIKE '%Da.5.%' OR shelfmark LIKE '%Da.6' OR shelfmark LIKE '%Da.6.%' OR shelfmark LIKE '%Da.7' OR shelfmark LIKE '%Da.7.%' OR shelfmark LIKE '%Da.8' OR shelfmark LIKE '%Da.8.%' OR shelfmark LIKE '%Da.9' OR shelfmark LIKE '%Da.9.%' ORDER by 'box' ASC"; }
		 ...
		 $sql_str="SELECT * FROM eua_box_contents WHERE shelfmark LIKE '%$searchterm1' OR shelfmark LIKE '%$searchterm2%' OR shelfmark LIKE '%$searchterm3%' OR shelfmark LIKE '%$searchterm4%' ORDER by 'box' ASC"; }
...
$boxsearch = mysqli_query($id_link, $sql_str) or die("Search Failed!");
while ($results = mysqli_fetch_array($boxsearch)):
echo "<tr><td><a href='".$PHP_SELF."?view=loc&amp;prefix=".$results['prefix']."&amp;box=".$results['box']."'>EUA-".$results['prefix']."-".$results['box']."</a></td><td>".$results['contents']."</td><td>".$results['unitid']."</td><td>".$results['shelfmark']."</td><td>".$results['notes']."</td></tr>";
endwhile;
echo "</table>";

		 $sql_str2="SELECT * FROM cms_unboxed WHERE shelfmark LIKE '%$searchterm1' OR shelfmark LIKE '%$searchterm2%' ORDER by 'box' ASC"; 
